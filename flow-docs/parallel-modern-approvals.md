...
> 
   ...
   ![bijwerkactie selecteren](./media/parallel-modern-approvals/update.png)

Selecteer **Stroom bewerken** bovenaan in het scherm om door te gaan met het aanbrengen van wijzigingen nadat u uw stroom hebt opgeslagen of bijgewerkt. Vervolgens kunt u verdergaan met wijzigingen aanbrengen.
...
> [!IMPORTANT]
> Met deze actie wordt de vakantieaanvraag verzonden naar het e-mailadres in het vak **Toegewezen aan**, dus voer het token **E-mail** uit de lijst **Manager ophalen** in.
> 
> 
...
1. Selecteer de pijl-omlaag tussen de kaart **Manager ophalen** en de kaart **Een goedkeuring starten**.
...
> [!IMPORTANT]
> Gebruik het e-mailadres van het Human Resources-team in het vak **Toegewezen aan** van de actie **Een goedkeuring starten**.
> 
> 
...
* Gebruik de kleine knop **Een nieuwe stap invoegen** (de kleine ronde knop met een plus die wordt weergegeven wanneer u witruimte in een vertakking of het gebied direct onder een vertakking selecteert). Deze knop voegt een stap toe aan die **specifieke vertakking**. Stappen die u met deze knop toevoegt worden uitgevoerd nadat deze specifieke vertakking is voltooid.
* Gebruik de grotere knop **Nieuwe stap** onder aan de volledige werkstroom. Deze knop voegt een actie toe die wordt uitgevoerd nadat **alle takken** zijn voltooid. Stappen die u met deze knop toevoegt, worden uitgevoerd nadat alle vertakkingen zijn voltooid.

In de volgende secties gebruiken we de kleine knop **Een nieuwe stap invoegen** om de volgende stappen in elke vertakking uit te voeren:
...
Voer de volgende stappen uit aan de zijde **INDIEN JA, NIETS DOEN** van de vertakking **Voorwaarde**.
...
Gebruik de zijde **INDIEN NEE, NIETS DOEN** van de vertakking **Voorwaarde** om een e-mailbericht te verzenden wanneer een aanvraag wordt afgewezen. Herhaal vervolgens de voorgaande stappen voor het toevoegen van een sjabloon voor de afwijzing via e-mail.
...
2. Gebruik de stappen die u eerder hebt gebruikt om een e-mailbericht te verzenden met een overzicht van de resultaten van elke goedkeuring. Verzend dit e-mailbericht naar de werknemer die de vakantie heeft aangevraagd. Uw kaart lijkt mogelijk op dit voorbeeld:
