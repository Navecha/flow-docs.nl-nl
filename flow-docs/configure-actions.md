---
title: Acties voor werk stromen configureren in PowerApps | MicrosoftDocs
ms.custom: ''
ms.date: 06/27/2018
ms.reviewer: ''
ms.service: flow
...
ms.locfileid: "73547573"
---
# <a name="configure-custom-actions-from-a-workflow"></a>Aangepaste acties configureren vanuit een werk stroom
...
U kunt een aangepaste actie inschakelen vanuit een werk stroom zonder code te schrijven. Meer informatie: [aangepaste acties aanroepen vanuit een werk stroom](invoke-custom-actions-workflow-dialog.md).  
 ...
 U kunt ook een actie maken zodat een ontwikkelaar deze in code kan gebruiken of u moet een eerder gedefinieerde actie kunnen bewerken. Bekijk net als werk stroom processen het volgende:  
  
-   Wat moet u doen met de actie?  
  
-   Onder welke voor waarden moet de actie worden uitgevoerd?  
...
Acties hebben ook iets dat werk stroom processen niet: invoer-en uitvoer argumenten hebben. Meer informatie: [proces argumenten definiëren](configure-actions.md#BKMK_DefineProcessArgs)  
 ...
 **Proces argumenten definiëren**  
 In dit gebied geeft u de gegevens op die de actie verwacht te starten en welke gegevens uit de actie worden door gegeven. Meer informatie: [proces argumenten definiëren](configure-actions.md#BKMK_DefineProcessArgs)  
  
 **Fasen, voor waarden en acties toevoegen**  
 Net als bij andere processen geeft u op welke acties moeten worden uitgevoerd en wanneer ze moeten worden uitgevoerd. Meer informatie: [fases, voor waarden en acties toevoegen](configure-actions.md#BKMK_AddStagesConditionsAndActions)
...
## <a name="next-steps"></a>Volgende stappen  
 ...
 [Aangepaste acties aanroepen vanuit een werk stroom](invoke-custom-actions-workflow-dialog.md)   
 [Real-time werk stromen en acties bewaken](monitor-manage-processes.md#BKMK_MonitorSyncWorkflows)
