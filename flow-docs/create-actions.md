...
Acties hebben ook iets dat werkstroomprocessen niet hebben: invoer- en uitvoerargumenten.
 ...
 **Fasen en stappen toevoegen**  
 Net als bij andere processen geeft u op welke acties moeten worden uitgevoerd en wanneer dit moet gebeuren. Meer informatie: [Fasen en stappen toevoegen](#add-stages-and-steps)
